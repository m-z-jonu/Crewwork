            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 flex items-center gap-2 px-3 py-2.5 rounded-xl border text-[13px] transition-all ${
                  !isPrivate ? 'border-[#DC2626] bg-[#FEE2E2]' : 'border-[#E7E5E4] hover:border-[#FECACA]'
                }`}
                style={{ color: !isPrivate ? '#DC2626' : '#78716C' }}
              >
              ...
              <div className="max-h-32 overflow-y-auto space-y-0.5 rounded-lg border border-[#E7E5E4] p-1">
                {filteredMembers.slice(0, 6).map((m) => (
                  ...
                  >
                    ...
                    <span style={{ color: '#1C1917' }}>{m.display_name}</span>
                    {m.email && <span className="text-[11px] ml-auto" style={{ color: '#A8A29E' }}>{m.email}</span>}
                  </button>
                ))}
              </div>
            )}
