    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center">
            <div className="relative group">
              {avatarPreview ? (
                ...
                <div className="h-24 w-24 rounded-2xl flex items-center justify-center text-3xl font-bold text-white" style={{ background: '#DC2626' }}>
                  {initial}
                </div>
              )}
              ...
              {statusEmojis.map((emoji) => (
                <button
                  ...
                  className={`h-7 w-7 rounded-lg flex items-center justify-center text-sm transition-all ${
                    statusEmoji === emoji ? 'bg-[#FEE2E2] ring-1 ring-[#DC2626]/30' : 'hover:bg-[#FEF2F2]'
                  }`}
                >
                  {emoji}
                </button>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave} disabled={saving || uploading} style={{ background: '#DC2626', color: '#fff' }}>
            {saving ? (
              <>
